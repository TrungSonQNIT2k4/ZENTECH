                ...
                <div class="content_bill_product">
                    ...
                    <div class="content_info_cancel">
                        ...
                        <div class="content_button">
                            ...
                            <a href="/..."><button><p>Mua lại</p></button></a>
                        </div>
                    </div>
                </div>
    <div class="return_popup">
        <ul class="choice">
            ...
            <li>
                <a hrel="/...">
                    <button>
                        <a href="order_require_return.php"><p class="reason_choice">Tôi đã nhận được hàng nhưng có vấn đề (bể vỡ, sai mẫu, hàng lỗi, khác mô tả...)-Miễn ship hoàn về</p></a>
                    </button>
                </a>
            </li>
            <li>
                <a href="..."><button>
                        <a href="order_require_return.php">
