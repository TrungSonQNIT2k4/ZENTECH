...
<ul id="globalnav-tool" class="globalnav-tool">
    ...
    <li class="globalnav-tool-content">
        <a href="/ZENTECH/Pro5-Login&register/login.php"><img src="/ZENTECH/Data/Image/store.png" alt="" class="icon"></a>
    </li>
    <li class="globalnav-tool-content">
        <a href="/ZENTECH/Pro5-Login&register/login.php"><img src="/ZENTECH/Data/Image/login.png" alt="" class="icon"></a>
    </li>
</ul>
</div>
</div>